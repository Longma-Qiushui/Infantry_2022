...
void SteeringEngine_Configuration(void)
{
	...
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource1,GPIO_AF_TIM5);			//引脚复用
  ...
  GPIO_InitStruct.GPIO_OType=GPIO_OType_PP;
	...
	TIM_OC2Init(TIM5,&TIM_OCInitStruct);											//Channel4配置
  ...
  TIM_SetCompare2(TIM5,Infantry.MagClose);
//	GPIO_InitTypeDef GPIO_InitStruct;
//	TIM_TimeBaseInitTypeDef TIM_TimeBaseInitStruct;
//	TIM_OCInitTypeDef TIM_OCInitStruct;												//初始化结构体
//	
