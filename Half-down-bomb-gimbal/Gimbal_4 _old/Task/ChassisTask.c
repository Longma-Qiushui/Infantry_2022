...
{
	pidChassisPosition.P = 2.5f;				//2.0					//双环1.0f
	pidChassisPosition.I = 0.000f;					
	...
	pidChassisPosition_Speed.P = 2.5f;			//2.3
	pidChassisPosition_Speed.I = 0.01f;
	pidChassisPosition_Speed.D = 0.0f;
	pidChassisPosition_Speed.IMax = 1000.0f;
