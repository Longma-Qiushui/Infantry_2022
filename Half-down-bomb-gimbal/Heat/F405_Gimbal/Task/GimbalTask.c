...
void Gimbal_Armor_Cal(Remote rc,Mouse mouse,PC_Receive_t *Pc_Recv)
{
  ...
  if(fabs(GimbalYawPos-Gimbal.Yaw.Gyro)<1.0f && fabs(GimbalPitchPos-Gimbal.Pitch.MotorTransAngle)<1.0f)
	{
	 Aim_Follow = 1;
	}
	else
...
//	  if(fabs(GimbalYawPos-Gimbal.Yaw.MotorTransAngle)<0.7f && fabs(GimbalPitchPos-Gimbal.Pitch.MotorTransAngle)<0.7f)
//	{
	 Aim_Follow = 1;
//	}
//	else
