...
void ChassisCan1Send(short a,short b,short c,short d)
{
    ...
    chassis_send[1]=  1000;
		...
		K_Power = 0.001f/JudgeReceive.realChassispower*(ABS(ChassisMotorCanReceive[0].RealSpeed)+ABS(ChassisMotorCanReceive[1].RealSpeed)+ABS(ChassisMotorCanReceive[2].RealSpeed)+ABS(ChassisMotorCanReceive[3].RealSpeed));
		//1000   1700
